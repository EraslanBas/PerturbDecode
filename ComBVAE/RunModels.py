...
@click.option("--controlfile", 
              type=click.STRING, 
              default="/home/eraslab1/Projects/E3Ligase/analysisSingle/ComboData_v2/outputs/anndata/adataControl.h5ad",
              help="test control cells h5ad file")

@click.option('--valfile', 
              type=click.STRING, 
              default='/home/eraslab1/Projects/E3Ligase/analysisSingle/ComboData_v2/outputs/anndata/adataKOSingles_test.h5ad',
...
#     os.chdir(project_dir)
    ...
    for epoch in range(max_epochs):
        ...
        if test_summary[loss_tracked] < best_loss:
            ...
            save_checkpoint(current_state=current_state, 
                            filename=os.path.join(save_dir,model_dir,"best.pth"))
    ...
    errorDF.to_csv(os.path.join(save_dir,model_dir,"TrainTestErrors.csv"))
